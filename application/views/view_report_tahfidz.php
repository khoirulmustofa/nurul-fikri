    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php if ($data_tahfidz->num_rows() > 0) { ?>
                    <h3 class="box-title"><i class="icon fa fa-fw fa-table"></i>Laporan Tahfidz, Periode <?php echo tgl_indo(date_to_eng($tgl_mulai)) ?> Sampai <?php echo tgl_indo(date_to_eng($tgl_akhir)) ?></h3>

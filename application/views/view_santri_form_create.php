            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group <?php echo set_validation_style('siswa_NIS') ?>">
                        ...
                        <input type="text" name="siswa_NIS" class="form-control" value="<?php echo $siswa_NIS; ?>" placeholder="Masukan NIS ...">
                    </div>
                    <div class="form-group <?php echo set_validation_style('siswa_NISN') ?>">
                        <label>NISN</label>
                        <?php echo form_error('siswa_NISN') ?>
                        <input type="text" name="siswa_NISN" class="form-control" value="<?php echo $siswa_NISN; ?>" placeholder="Masukan NISN ...">
                    </div>
